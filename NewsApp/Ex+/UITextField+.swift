...
extension UITextField {
    ...
    func addBorderColor(color: UIColor = .mainWhite, borderWidth: CGFloat = 1, cornerRadius: CGFloat = 7) {
...
//class VerifyTextField : SkyFloatingLabelTextField {
//    
//    override func awakeFromNib() {
//        super.awakeFromNib()
//        textColor = .hex("#1E1E1E")
//        lineColor = .hex("#E9E8F8")
//        selectedLineColor = .hex("#1E1E1E")
...
extension UITextField {
    ...
    @objc func fix(textField: UITextField) {
        ...
        textField.text = "\(t?.prefix(maxLength) ?? "0")"
    }
}
