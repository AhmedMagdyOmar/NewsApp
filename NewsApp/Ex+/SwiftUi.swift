...
extension SwiftUI where Self: UIView {
    ...
    @discardableResult
    func withBorder(width: CGFloat = 1.2, color: UIColor = .mainColor) -> Self {
...
extension SwiftUI where Self: UIButton {
    ...
    @discardableResult
    func withFont(_ value: UIFont = .mainMedium(of: 15)) -> Self {
...
extension SwiftUI where Self: UITextField {
    ...
    @discardableResult
    func withPlaceHolderColor(_ value: UIColor, holderText: String) -> Self {
        attributedPlaceholder = NSAttributedString(string: holderText, attributes: [NSAttributedString.Key.foregroundColor : value])
        return self
    }
...
struct UIConstants {
    static let mainLableFont: UIFont = .mainMedium(of: 16)
    static let mainTextFieldFont: UIFont = .mainMedium(of: 16)
}
