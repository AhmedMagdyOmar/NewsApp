...
extension UIView {
    ...
    func applySketchShadow(color: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.19), alpha: CGFloat = 0.2, x: CGFloat = 0, y: CGFloat = 3, blur: CGFloat = 16, spread: CGFloat = 0) {
        // #000000 , 2% , 0 , 3 , 16
